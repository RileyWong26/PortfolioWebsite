...
export default async function About(){
    return (
            ...
            <div className="w-full flex flex-col animate-pullup min-h-screen ">
                {/*Page Title */}
                <h1 className="text-hightlight h-[10vh] font-bold text-3xl w-4/5 mx-auto content-end mt-auto">
                    About Me
                </h1>
                {/*Page content */}
                <section className="w-full flex flex-col-reverse lg:flex-row py-10 space-y-5 lg:h-[50vh] content-center mb-auto">
                    {/* Left side text*/}
                    ...
                    <div className="mx-auto w-full min-h-[33vh] lg:min-h-[50vh] animate-pullup content-center mb-5 ">
